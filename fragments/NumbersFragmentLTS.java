...
public class NumbersFragmentLTS extends Fragment {
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_numbers_lts, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        hintBtn = view.findViewById(R.id.hint_number_button);
        checkBtn = view.findViewById(R.id.check_number_button);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(NumbersFragmentLTS.this)
                        .navigate(R.id.numbers_to_home_lts);
            }
        });
    ...
    private void SetQuestionAndResetDots()
    {
        ...
        numberView.setText(Question.GetSymbol());
