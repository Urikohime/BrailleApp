...
public class MixedFragmentSTL extends Fragment {
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mixed_stl, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        answer = view.findViewById(R.id.mixed_input_stl);

        hintBtn = view.findViewById(R.id.hint_mixed_button_stl);
        checkBtn = view.findViewById(R.id.check_mixed_button_stl);
        ...
        backBtn.setOnClickListener(v -> NavHostFragment.findNavController(MixedFragmentSTL.this)
                .navigate(R.id.mixed_to_home_stl));
