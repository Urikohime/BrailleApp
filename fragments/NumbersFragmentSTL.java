...
public class NumbersFragmentSTL extends Fragment {
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_numbers_stl, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        answer = view.findViewById(R.id.number_input_stl);

        hintBtn = view.findViewById(R.id.hint_number_button_stl);
        checkBtn = view.findViewById(R.id.check_number_button_stl);
        ...
        backBtn.setOnClickListener(v -> NavHostFragment.findNavController(NumbersFragmentSTL.this)
                .navigate(R.id.numbers_to_home_stl));
    ...
    private void SetQuestionAndResetDots()
    {
        ...
        Question = QuestionGenerator.getQuestionNumber();
